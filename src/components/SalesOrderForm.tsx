...
import { Package, Search, CheckCircle, AlertCircle, Users, DollarSign, Calendar, MapPin } from 'lucide-react';
...
const SalesOrderForm: React.FC = () => {
  ...
  const loadCustomersAndBrokers = async () => {
    try {
      ...
      console.error('Error loading customers and brokers:', error);
    }
  };
  ...
  const handleConfirmSelection = () => {
    ...
    setOrderData(prev => ({
      ...
      allocated_lots: selectedLotData
    }));
