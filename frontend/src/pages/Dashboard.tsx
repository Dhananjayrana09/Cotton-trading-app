...
const Dashboard: React.FC = () => {
  ...
  const loadStats = async () => {
    try {
      ...
      // Convert the new stats format to ParsingStats format
      setStats({
        total_emails: statsData.total,
        successful_parsing: statsData.processed,
        failed_parsing: statsData.failed,
        pending_review: statsData.pending_review,
        average_confidence: statsData.processed > 0 ? 85 : 0 // Calculate or use default
      });
    } catch (error) {
